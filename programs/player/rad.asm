...
;          £
;          . ???áá?š  š??áááá  š?ááš  ???     ??? ?????š  ??  ??? £
;          : ???šš?á  ???šš   ???šš?í ???     ???    á??í á?šš??? :
;          ? ??? á??š ???     ???  ?? ???š    ???     ???     ??? |
;  é Ž ŽÖŽÖ? ááá   ááá áááááá ááá  áá  áááááá ááá     ááá áááááá  ?ŽŽ Ž -ŽŽŽ?
;  ? š?ááš ??ááš ??    ?? ??ááš   ááá?š ??ááš š?ááš š?ááš ??  ? š?ááá ??ááš :
;  | ??áá? ??  ? ??    ?? ??ááš      ?? ??ááš ??áá? ??  š ??ááš ??á   ??ááš .
;  : áá  á áááá   áááá áá áááá       áá áá  á áá  á  ááá  áá  á  áááá áá  á £
